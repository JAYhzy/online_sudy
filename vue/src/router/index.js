...
const routes = [
  {
    ...
    children: [
      ...
      { path: 'fileOrder', name: 'FileOrder', meta: { name: '历史下载' }, component: () => import('../views/manager/FileOrder') },
    ]
  },
  {
    path: '/front',
    ...
    children: [
      ...
      { path: 'truehome', name: 'truehome', meta: { name: '主页' }, component: () => import('../views/front/truehome') },
      { path: 'course', name: 'Cou  rse', meta: { name: '全部课程' }, component: () => import('../views/front/Course') },

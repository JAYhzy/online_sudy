      ...
      <div style="width: 76%; margin: 50px auto; min-height: 1000px">
        ...
        <div style="display: flex; margin-top: 20px; height: 300px">
          <div style="flex: 1; margin-right: 10px; width: 0">
            <img :src="recommend.img" alt="" style="width: 100%; height: 350px; border-radius: 5px; cursor: pointer" @click = "navTo(recommend.id)">
          ...
          <div style="flex: 2; margin-left: 10px">
            <el-row :gutter="20">
              <el-col :span="6" style="margin-bottom: 35px" v-for="item in rightData">
                <img :src="item.img" alt="" style="width: 100%; height: 150px; border-radius: 5px; border: 1px solid #cccccc; cursor: pointer" @click = "navTo(item.id)">
          ...
          <div style="flex: 2; margin-right: 10px">
            <el-row :gutter="20">
              <el-col :span="6" style="margin-bottom: 35px" v-for="item in leftData">
                <img :src="item.img" alt="" style="width: 100%; height: 150px; border-radius: 5px; border: 1px solid #cccccc; cursor: pointer" @click = "navToInformation(item.id)">
                <div style="color: #333333; margin-top: 10px" class="overflowShow">{{ item.name }}</div>
              </el-col>
            </el-row>
          </div>
          <div style="flex: 1; margin-left: 10px; width: 0">
            <img :src="fileRecommend?.img" alt="" style="width: 100%; height: 330px; border-radius: 5px; cursor: pointer" @click = "navToInformation(fileRecommend.id)">
...
export default {
  ...
  data() {
    return {
      carouselData: [
        require('@/assets/imgs/takagi5.png'),
        // require('@/assets/imgs/takagi2.png'),
        // require('@/assets/imgs/takagi3.png'),
        // require('@/assets/imgs/takagi4.png'),
        // require('@/assets/imgs/takagi6.png'),
        // require('@/assets/imgs/takagi7.png'),
        // require('@/assets/imgs/takagi8.png'),
        // require('@/assets/imgs/takagi9.png'),
      ],
